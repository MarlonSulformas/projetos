...
const AuthenticatedApp = () => {
  ...
  if (isLoadingPublicSettings || isLoadingAuth) {
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-[#F7F7FA]">
        <div className="flex flex-col items-center gap-3">
          <div className="w-8 h-8 border-[3px] border-[#E5E5E8] border-t-[#3B82F6] rounded-full animate-spin" />
          <span className="text-xs text-[#6B6B72] font-medium tracking-wide">Carregando plataforma...</span>
        </div>
      </div>
    );
  }
